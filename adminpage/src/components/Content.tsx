 ...
 useEffect(() => {
  ...
  return (
    <div className={`p-4 bg-white shadow-md h-full overflow-auto ${className}`}>
            ...
            >
              {item.icon && (
                <div
                  ...
                  style={{ backgroundColor: '#FEF0F5FF' }}
                >
              ...
              <div className="flex items-center">
                <span
                  className={`text-sm ${item.change.percentage >= 0 ? 'text-green-500' : 'text-red-500'}`}
                >
      ...
      <TableDetail page={page} setPage={setPage} rowsPerPage={rowsPerPage} />
    </div>
  );
};
